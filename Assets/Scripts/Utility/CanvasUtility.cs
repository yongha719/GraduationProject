...
public class CanvasUtility : MonoBehaviour
{
    ...
    /// <returns> 상대 필드의 Bottom Left와 Top Right를 (Vector2, Vector2) 튜플로 반환 </returns>
    public static (Vector2, Vector2) GetEnemyFieldPosition()
    {
        return (EnemyFieldBottomLeft, EnemyFieldBottomRight);
    }

    /// <returns> - 내 필드의 Bottom Left와 Top Right를 AnchorPosition (Vector2, Vector2) 튜플로 반환 </returns>
